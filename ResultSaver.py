...
def cm1i(start1, end1):
    ...
    with open("E:\\Nilesh\\Python Project\\1styear.csv", 'w', newline='') as f:
        w = csv.writer(f)
    ...
    for seat_number in range(start,end):
        ...
        with open("C:\\Users\\Nilesh\\Desktop\\1st.csv", 'a', newline='') as f:
            w = csv.writer(f)
            w.writerow(marks)
        del marks[:]
...
def cm3i(start1, end1):
    ...
    final_header = headers + ['total marks','percentage','remarks']
    with open("E:\\Nilesh\\Python Projrct\\2ndyear.csv", 'w', newline='') as f:
        w = csv.writer(f)
        w.writerow(final_header)
    ...
    for seat_number in range(start,end):
        ...
        marks.append(remarks)
        #add to the excel sheet
        with open("C:\\Users\\Nilesh\\Desktop\\2nd.csv", 'a', newline='') as f:
            w = csv.writer(f)
            w.writerow(marks)
        del marks[:]
...
def cm5i(start1, end1):
    ...
    final_header = headers + ['total marks','percentage','remarks']
    with open("E:\\Nilesh\\Python Projrct\\3rd.csv", 'w', newline='') as f:
        w = csv.writer(f)
        w.writerow(final_header)
    ...
    for seat_number in range(start,end):
        ...
        marks.append(remarks)
        #add to the excel sheet
        with open("C:\\Users\\Nilesh\\Desktop\\3rd.csv", 'a', newline='') as f:
            w = csv.writer(f)
            w.writerow(marks)
        del marks[:]
